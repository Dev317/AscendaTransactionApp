...
TEST_CSV_FILE_HEADER = ['id', 'card_id', 'merchant', 'mcc', 'currency', 'amount', 'sgd_amount', 'transaction_id', 'date', 'card_pan', 'card_type']
TEST_CSV_FILE_CONTENT = ['7ce56f44-659a-453f-8bc4-5a102faada42', '0fd148a9-a350-4567-9e6d-d768ab9c1932', 'Collier', 4642, 'SGD', 285.96, 0, '07110e8bf85f1a1229eaa5dcbdea68c51d537218143d0021945cfae8861e3efc', '27/8/2021', '6771-8964-5359-9669', 'scis_platinummiles']
...
class TestLambdaFunction(unittest.TestCase):
    def setUp(self):
        ...
        self.table = boto3.resource('dynamodb', region_name='ap-southeast-1').Table(DYNAMODB_TABLE_NAME)

    def test_get_data_from_file(self):
        from handler import get_data_from_file
    ...
    def test_save_data_to_db(self):
        from handler import save_data_to_db
