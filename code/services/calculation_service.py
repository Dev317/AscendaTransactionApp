...
def generate_policies(left_bound_date, right_bound_date):
    ...
    return {"statusCode": 200, "body": "Sucessfully regenerated"}
    ...
    for card_type in new_exclusion["card_type"]:
        ...
        try:
            ...
            if policy:
                ...
                policy = {"exclusion_conditions": new_exclusion["exclusion_conditions"]}
            ...
            LOGGER.error(
                "exception encountered while adding exclusion to policy: %s",
                str(exception),
            )
